...
export default function ApiDocs() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-stellar-text-primary">API Reference</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-4 space-y-1">
          <p className="text-sm font-semibold text-stellar-text-primary">Authentication</p>
        ...
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-4 space-y-1">
          <p className="text-sm font-semibold text-stellar-text-primary">Rate Limiting</p>
          <p className="text-sm text-stellar-text-secondary">
            ...
            The <span className="font-mono text-stellar-text-primary">Retry-After</span> header indicates when to retry.
          </p>
        </div>
      </div>
      ...
      <div className="bg-stellar-card border border-stellar-border rounded-lg px-4 py-3 flex items-center gap-3">
        ...
        <code className="text-sm text-stellar-text-primary font-mono">https://api.swipely.stellar.org</code>
      </div>
        ...
        CATEGORIES.filter((cat) => filtered.some((e) => e.category === cat)).map((cat) => {
          ...
          return (
            <section key={cat} className="space-y-3">
              <h2 className="text-lg font-semibold text-stellar-text-primary border-b border-stellar-border pb-2">{cat}</h2>
              {group.map((endpoint) => (
