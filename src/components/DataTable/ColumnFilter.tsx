...
export function ColumnFilter<TData>({
  ...
  if (filterType === "boolean") {
    ...
    return (
      <select
        className="mt-2 w-full bg-stellar-dark border border-stellar-border rounded px-2 py-1 text-xs text-stellar-text-primary"
  ...
  if (filterType === "numberRange") {
    ...
    return (
      <div className="mt-2 flex items-center gap-2">
        <input
          className="w-full bg-stellar-dark border border-stellar-border rounded px-2 py-1 text-xs text-stellar-text-primary"
          placeholder="Min"
          inputMode="decimal"
