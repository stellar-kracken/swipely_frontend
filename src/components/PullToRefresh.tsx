...
export default function PullToRefresh({
  ...
  return (
    ...
    >
      <div
        className="mt-2 inline-flex items-center gap-3 rounded-full border border-stellar-border bg-stellar-card/95 px-4 py-2 text-xs text-stellar-text-primary shadow-lg backdrop-blur"
        style={{
