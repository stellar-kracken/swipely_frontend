  ...
  if (isLoading) {
    return (
      <div className="bg-stellar-card border border-stellar-border rounded-xl p-6">
        <h3 className="text-lg font-semibold text-stellar-text-primary mb-4">Volume Analytics</h3>
        ...
        <div className="grid grid-cols-3 gap-4">
          {data.volume24h !== undefined && (
            <div>
              ...
              <p className="text-lg font-semibold text-stellar-text-primary">${data.volume24h.toLocaleString()}</p>
            </div>
          )}
          {data.volume7d !== undefined && (
            <div>
              <p className="text-xs text-stellar-text-secondary">7D Volume</p>
              <p className="text-lg font-semibold text-stellar-text-primary">${data.volume7d.toLocaleString()}</p>
            </div>
          )}
          {data.volume30d !== undefined && (
            <div>
              <p className="text-xs text-stellar-text-secondary">30D Volume</p>
              <p className="text-lg font-semibold text-stellar-text-primary">${data.volume30d.toLocaleString()}</p>
            </div>
          )}
        </div>
      ) : (
